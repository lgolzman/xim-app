        ...
        <div className="bg-white border border-gray-200 rounded-lg">
          <div className="border-b border-gray-200">
            <nav className="flex -mb-px overflow-x-auto">
              <Link
                to="/exercises"
                className="shrink-0 px-6 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 transition-colors hover:text-gray-700 hover:border-gray-300"
              >
                Ejercicios
              </Link>
              {tabs.map((tab) => (
                <button
                  ...
                  className={`
                    shrink-0 px-6 py-3 text-sm font-medium border-b-2 transition-colors
                    ${activeTab === tab.id
